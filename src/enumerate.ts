 ...
 */
export function renumerate(afterAll : boolean = false) : void {
    ...
    document.querySelectorAll("*").forEach(function(element : Element) {
        ...
        try {
            let result = (element as any).lc_number(getCounter());
    ...
    document.querySelectorAll('lc-ref').forEach(function(element : Element) {
